...
public class comm_UpEvents extends AppCompatActivity {
  ...
  int DummyEventImage[]={
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comm__up_events);
        ...
        switch(Value)
        {
            case 1121: s1=getResources().getStringArray(R.array.Comm_EVENT_TITLE);
