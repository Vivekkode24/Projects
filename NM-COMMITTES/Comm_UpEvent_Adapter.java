...
public class Comm_UpEvent_Adapter extends RecyclerView.Adapter<Comm_UpEvent_Adapter.MyViewHolder> {
    ...
    public Comm_UpEvent_Adapter(Context ct, String[] s1, String[] s2, int[] img, int Value) {
        context = ct;
        edata1= s1;
        edata2=s2;
        images=img;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view1= inflater.inflate(R.layout.comm_eventrow, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.emainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it= new Intent(context, CommUpEventsDisp.class);
